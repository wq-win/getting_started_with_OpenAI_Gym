...
class Chopper(Point):
    def __init__(self, name, x_max, x_min, y_max, y_min):
        ...
        self.icon = cv2.imread("picture/chopper.png") / 255.0
        self.icon_w = 64
        self.icon_h = 32
...
class Bird(Point):
    def __init__(self, name, x_max, x_min, y_max, y_min):
        ...
        self.icon = cv2.imread("picture/bird.png") / 255.0
        self.icon_w = 32
        self.icon_h = 32
        self.icon = cv2.resize(self.icon, (self.icon_w, self.icon_h))
...
class Fuel(Point):
    def __init__(self, name, x_max, x_min, y_max, y_min):
        ...
        self.icon = cv2.imread("picture/fuel.png") / 255.0
        self.icon_w = 32
        self.icon_h = 32
        self.icon = cv2.resize(self.icon, (self.icon_w, self.icon_h))
...
class ChopperScape(Env):
    ...
    def get_action_meanings(self):
        return {0: "Down", 1: "Up", 2: "Right", 3: "Left",  4: "Do Nothing"}

    def my_action_meanings(self,action):
        actiondict = {0: "Down", 1: "Up", 2: "Right", 3: "Left",  4: "Do Nothing"}
...
if __name__ == "__main__":
    ...
    while True:
        ...
        # action = int(input("you action"))
        # print(f'action:{action},meaning:{env.my_action_meanings(action)}')
        # time.sleep(1)
